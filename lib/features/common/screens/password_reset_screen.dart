  ...
  Future<void> _handleReset() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (mounted) _showGlowSnackBar('Password reset link sent successfully!Check your email to reset password.', isError: false);
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const RunwayReveal(
                   child: Icon(Icons.lock_reset_rounded, size: 80, color: Colors.cyanAccent),
                ),
